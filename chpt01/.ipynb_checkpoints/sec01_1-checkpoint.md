...
<div style="text-align: justify"> Em paralelo, foi aplicado um questionário aos OEMAs das 27 unidades federativas (UFs) do Brasil, visando obter as seguintes informações:
    <ul>
...
```
<div style="text-align: justify">As informações obtidas por meio do questionário foram compiladas e, em alguns casos, complementadas com os dados disponíveis no Sistema Nacional de Gestão da Qualidade do Ar (MonitorAr). A Tabela 1 sintetiza a origem dos dados e as características do monitoramento da qualidade do ar nas UFs brasileiras. A Tabela 2 indica a origem dos dados utilizados para a avaliação da qualidade do ar no Brasil no ano de 2024, nas UFs que possuem monitoramento do ar sistemático.</div><br/>
