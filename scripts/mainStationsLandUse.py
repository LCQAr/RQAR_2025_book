...
def build_map_varbuf(
    ...
    """
    Gera o mapa interativo de representatividade.
    Se save=True, salva em '_static/representatividade/bufferUsoDoSolo.html'.
    """
    ...
    # =======================================================
    # Garante que colunas de identificação sejam preservadas
    # =======================================================
    ...
    # Camadas por poluente (círculo real)
    ...
    # =====================
    if save:
        # Salva sempre em RQAR_2025_book/_static/representatividade/
        base = Path(rootPath or os.getcwd())
        default_path = base / "_static" / "representatividade" / "bufferUsoDoSolo.html"
        save_path = Path(save_path) if save_path else default_path
...
if __name__ == "__main__":
    m_var = build_map_varbuf(save=True)
    print("Mapa de representatividade gerado.")
