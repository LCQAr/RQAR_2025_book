...
inputs_path = '/home/nobre/Notebooks/' + root_path + '/05_verif_vias_e_limites/inputs'

# Caminho da pasta de outputs
outputs_path = root_path + '/05_verif_vias_e_limites/outputs'

# Caminhos dos subsets
co_path = os.readlink(inputs_path + '/subset_co.txt')
no2_path = os.readlink(inputs_path + '/subset_no2.txt')
o3_path = os.readlink(inputs_path + '/subset_o3.txt')
pm_path = os.readlink(inputs_path + '/subset_pm.txt')
so2_path = os.readlink(inputs_path + '/subset_so2.txt')
