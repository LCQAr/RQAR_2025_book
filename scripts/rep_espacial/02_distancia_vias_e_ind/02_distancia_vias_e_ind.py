...
subset_so2.to_parquet(outputs_path + '/subset_so2.parquet')"""Esse arquivo resulta em 5 variáveis, uma para cada poluente: subset_co, subset_no2, subset_o3, subset_pm, subset_so2.
